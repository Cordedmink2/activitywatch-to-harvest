...
| No assumed timezone: an unconfigured run refuses rather than guessing an offset | `scripts/aw_client.py` `resolve_utc_offset()` docstring | `SKILL.md` "Timezone", `references/activitywatch.md` §"Time zones", both scripts' module docstrings |
