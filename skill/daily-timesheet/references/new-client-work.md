...
- Confirm the resolved customer + title before the case is created. The **customer account determines the ticket prefix**, so you only supply client + title and the CRM assigns the number.
